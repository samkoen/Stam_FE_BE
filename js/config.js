...
export const config = {
    ...
    MESSAGES: {
        ...
        REFERENCE_MISMATCH_ANALYSIS_SKIPPED:
            'לא נמצאה התאמה במקורות לטקסט שנבחר. ייתכן שאיכות התמונה נמוכה, או שהיא אינה ישרה (הפוכה או נוטה הצידה). מומלץ ליישר את התמונה ולנסות להעלות צילום ברור ואיכותי יותר.',
        /** פרשה לא זוהתה — אין השוואה למקור */
        VERIFICATION_NOT_DONE:
            'לא זוהה סוג הטקסט. בדיקת הפרשה לא בוצעה — נא לבחור את סוג הטקסט או לצלם מחדש.',
    },
