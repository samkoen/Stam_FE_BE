...
export const config = {
    ...
    MESSAGES: {
        ...
        REFERENCE_MISMATCH_ANALYSIS_SKIPPED:
            'הטקסט שבחרת אינו תואם למה שזוהה בתמונה, או שלא נמצא מקטע מתאים במגילה/בתורה. לכן לא בוצע כאן ניתוח השוואתי (השוואת אותיות מול הטקסט שבחרת) — מוצגים רק תוצאות זיהוי האותיות מהתמונה.',
    },
